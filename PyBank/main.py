...
print("Greatest Increase in Revenue: " + greatest_increase_date
...
with open(output_file, 'w', newline='') as file:
    ...
    file.write("Greatest Increase in Revenue: " + greatest_increase_date
        + " ($" + str(greatest_increase) + ")\n")
    file.write("Greatest Decrease in Revenue: " + greatest_decrease_date
        + " ($" + str(greatest_decrease) + ")\n")
