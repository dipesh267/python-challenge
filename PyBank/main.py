...
print("Greatest Decrease in Revenue: " + greatest_decrease_date + " ($" + str(greatest_decrease) + ")")
...
with open(output_file, 'w', newline='') as file:
    ...
    file.write("Greatest Decrease in Revenue: " + greatest_decrease_date + " ($" + str(greatest_decrease) + ")\n")
